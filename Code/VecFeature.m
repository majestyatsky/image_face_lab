...
%  Output: row vector required to compute the response for the feature
%  defined
...
%     h2 = H - h1;
    ftype_vec =...
      VecBoxSum(x, y, w, h, W, H) - VecBoxSum(x, y + h, w, h, W, H);
  case 2
    %% Type II feature
%     w1 = floor(W / 2);
%     w2 = W - w1;
%     h = H;
    ftype_vec =...
      - VecBoxSum(x, y, w, h, W, H) + VecBoxSum(x + w, y, w, h, W, H);
  case 3
    %% Type III feature
%     w1 = floor(W / 3);
%     w2 = w1;
